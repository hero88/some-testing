...
const Form6COM = ({ intl, isReadOnly }) => {
      ...
      <Row>
          ...
          <Row>
            <Col>
              <h4 className="typo-section mb-2">
                <FormattedMessage id="EVN start index of meter" />
              </h4>
            </Col>
          </Row>
          <Row>
        ...
        <Col className="mb-2 " md={{ size: 5, offset: 1 }}>
          <Row>
            <Col>
              <h4 className="typo-section mb-2">
                <FormattedMessage id="EVN end index of meter" />
              </h4>
            </Col>
          </Row>
          <Row>
...
export const Form6 = injectIntl(Form6COM)
